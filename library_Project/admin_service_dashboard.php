...
body{
    background-image: url('https://png.pngtree.com/background/20210709/original/pngtree-office-items-picture-desk-on-the-desktop-picture-image_408181.jpg')
}
...
elseif($msg=="fail"){
    ...
    ?>
        ...
        <div class="container">
        <div class="innerdiv">
            <div class="row"><img class="imglogo" src="https://cpb-us-w2.wpmucdn.com/sites.uwm.edu/dist/4/404/files/2016/12/DLTRE-header.png"/></div>
            ...
            <div><label>Branch:</label><input type="radio" name="branch" value="MCA(4A)"/>MCA(4A)<input type="radio" name="branch"value="M.Tech"/>M.Tech<div style="margin-left:80px"><input type="radio" name="branch" value="B.Tech"/>B.Tech<input type="radio" name="branch" value="Other"/>Other</div >
            </div>   
